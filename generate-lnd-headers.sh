...
sed -i 's/# Generated by the gRPC Python protocol compiler plugin. DO NOT EDIT!/# Generated by generate-lnd-headers-sh. DO NOT EDIT!/g' lib/rpc_pb2_grpc.py
sed -i 's/# Generated by the protocol buffer compiler.  DO NOT EDIT!/# Generated by generate-lnd-headers-sh. DO NOT EDIT!/g' lib/rpc_pb2.py
echo "Cleaning up"
rm rpc.proto
